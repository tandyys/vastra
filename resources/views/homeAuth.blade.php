      ...
      <div class="card-wrapper">
        ...
        <div class="card" style="width: 21rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            <a href="/newscontent" class="btn-card">Read More</a>
          </div>
        </div>
      ...
      <div class="card-product-wrapper">
        <div class="product-content">
            <div class="product-img">
                <img src="/assets/product1.png" alt="..." href="#">
            </div>
            ...
            <div class="product-desc">
                ...
                <h5>New Balian Encim Megamendung</h5>
        ...
        <div class="product-content">
            <div class="product-img">
                <img src="/assets/product2.jpeg" alt="..." href="#">
            </div>
            ...
            <div class="product-desc">
                ...
                <h5>Set Couple Megamendung Kuning</h5>
        ...
        <div class="product-content">
            <div class="product-img">
                <img src="/assets/product3.jpeg" alt="..." href="#">
            </div>
            ...
            <div class="product-desc">
                ...
                <h5>Dress Megamendung Pepaya Erly</h5>
        ...
        <div class="product-content">
            <div class="product-img">
                <img src="/assets/product4.jpeg" alt="..." href="#">
            </div>
